...
class ModelExtensionShippingUkrpost extends Model
{
    ...
    function getQuote($address)
    {
        ...
        $image = HTTP_SERVER.'image/catalog/shipping/cur_ukrpost.jpg';
        ...
        if ($status)
        {
            ...
            $quote_data['ukrpost'] = array(
                ...
                'text' => $this->currency->format($this->tax->calculate($this->config->get('ukrpost_cost'), $this->config->get('ukrpost_tax_class_id'), $this->config->get('config_tax')), $this->session->data['currency'])
            );
