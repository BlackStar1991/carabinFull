...
class ModelExtensionShippingPony extends Model
{
    ...
    function getQuote($address)
    {
        ...
        $image = HTTP_SERVER.'image/catalog/shipping/cur_pony.jpg';
        ...
        if ($status)
        {
            ...
            $quote_data['pony'] = array(
                'code' => 'pony.pony',
                'title' => $image_html.' '.$this->language->get('text_description'),
                'cost' => $this->config->get('pony_cost'),
                'tax_class_id' => $this->config->get('pony_tax_class_id'),
                'text' => $this->currency->format($this->tax->calculate($this->config->get('pony_cost'), $this->config->get('pony_tax_class_id'), $this->config->get('config_tax')), $this->session->data['currency'])
            );
            ...
            $method_data = array(
                ...
                'quote' => $quote_data,
                'sort_order' => $this->config->get('pony_sort_order'),
                'error' => false
            );
        }
