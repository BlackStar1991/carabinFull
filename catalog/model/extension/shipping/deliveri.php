...
class ModelExtensionShippingDeliveri extends Model
{
    ...
    function getQuote($address)
    {
        ...
        $image = HTTP_SERVER.'image/catalog/shipping/cur_delivery.jpg';
        ...
        if ($status)
        {
            ...
            $quote_data['deliveri'] = array(
                ...
                'cost' => $this->config->get('deliveri_cost'),
                'tax_class_id' => $this->config->get('deliveri_tax_class_id'),
                'text' => $this->currency->format($this->tax->calculate($this->config->get('deliveri_cost'), $this->config->get('deliveri_tax_class_id'), $this->config->get('config_tax')), $this->session->data['currency'])
            );
            ...
            $method_data = array(
                ...
                'quote' => $quote_data,
                'sort_order' => $this->config->get('deliveri_sort_order'),
                'error' => false
            );
        }
