...
class ModelExtensionShippingSat extends Model
{
    ...
    function getQuote($address)
    {
        ...
        $image = HTTP_SERVER.'image/catalog/shipping/cur_sat.png';
        ...
        if ($status)
        {
            ...
            $quote_data['sat'] = array(
                ...
                'cost' => $this->config->get('sat_cost'),
                'tax_class_id' => $this->config->get('sat_tax_class_id'),
                'text' => $this->currency->format($this->tax->calculate($this->config->get('sat_cost'), $this->config->get('sat_tax_class_id'), $this->config->get('config_tax')), $this->session->data['currency'])
            );
            ...
            $method_data = array(
                ...
                'quote' => $quote_data,
                'sort_order' => $this->config->get('sat_sort_order'),
                'error' => false
            );
        }
