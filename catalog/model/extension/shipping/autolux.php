    ...
    function getQuote($address)
    {
        ...
        if ($status)
        {
            ...
            $quote_data['autolux'] = array(
                ...
                'cost' => $this->config->get('autolux_cost'),
                'tax_class_id' => $this->config->get('autolux_tax_class_id'),
                'text' => $this->currency->format($this->tax->calculate($this->config->get('autolux_cost'), $this->config->get('autolux_tax_class_id'), $this->config->get('config_tax')), $this->session->data['currency'])
            );
